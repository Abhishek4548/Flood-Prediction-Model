...
table.heading("Risk", text="Risk")
table.heading("Precip", text="Precipitation (mm)")
table.heading("Humidity", text="Humidity (%)")
table.heading("Precip Prob", text="Probability of precipitation (%)")
